...
<template>
    <RouterLink
        ...
        class="justify-center uppercase font-bold text-lg/4.5 rounded-none border-brand-y border-1 w-fit flex flex-row flex-wrap items-center gap-x-2  px-6 py-3 transition-all duration-300" 
        :to="link.href ?? '#'">
