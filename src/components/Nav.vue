...
<template>
    <nav>
        <div class="max-w-5xl mx-auto px-5 flex flex-row items-center justify-between sm:px-8 py-2.5 sm:py-5">
            <a class="block" href="/">
            ...
            <!-- tab -->
            <div class="bg-surface fixed bottom-0 left-0 right-0 sm:relative">
            ...
            <div class="flex flex-row gap-4">
                ...
                <a  href="https://github.com/shakilnwz" target="_blank">
                    <svg class="h-5" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 23 22">
                        <path
                            class="fill-current text-brand-x"
                            fill-rule="evenodd"
                ...
                <div class="cursor-pointer">
                    <svg class="h-5" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 22 22">
                        <path
                            class="fill-current text-brand-x"
                            fill-rule="evenodd"
                            d="M11.621.09C5.556.09.646 5.017.646 11.09c0 6.075 4.91 11 10.975 11 2.976 0 5.672-1.188 7.651-3.113a.785.785 0 0 0-.682-1.335 8.616 8.616 0 0 1-1.479.127c-4.758 0-8.618-3.87-8.618-8.642a8.64 8.64 0 0 1 4.385-7.529.785.785 0 0 0-.324-1.463c-.31-.025-.619-.04-.933-.04V.092Z" 
                            clip-rule="evenodd"
                        />
                    </svg>
                </div>
