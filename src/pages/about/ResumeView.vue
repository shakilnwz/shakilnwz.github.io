  ...
  <Section contained class="print:max-w-5xl print:p-0">
    ...
    <div class="resume">
      ...
      <div class="px-6">
        ...
        <ul class="education">
          <li
            v-for="(education, index) in resumeContent.education"
            :key="index"
          >
      ...
      <div class="col-span-2 px-6">
        ...
        <p class="text-justify pb-4 pt-2">
          ...
          in creating responsive, optimized, and user-focused websites.
          Committed to leveraging the latest web technologies to build fast,
          feature-rich, and accessible online experiences.
        </p>
        <!-- contact section -->
